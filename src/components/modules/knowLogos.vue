  ...
  <q-card-section class="q-pt-none q-pb-sm">
    ...
    >
      <div class="col-4">
        ...
        >
          <!-- vue {{{1 -->
          <svg width="100%" viewBox="0 0 261.76 226.69">
      ...
      <div class="col-4">
        ...
        >
          <!-- Quasar {{{1 -->
          <svg width="100%" viewBox="0 0 126 126">
      ...
      <div class="col-4">
        ...
        >
          <!-- Firebase{{{1 -->
          <svg width="100%" viewBox="0 6 132 132">
            <defs>
              <linearGradient
                id="a"
                x1="-3.49%"
      ...
      <div class="col-4">
        ...
        >
          <!-- vuetify{{{1 -->
          <svg width="90%" viewBox="0 0 2187.5 2500">
      ...
      <div class="col-4">
        ...
        >
          <!-- figma{{{1 -->
          <svg viewBox="0 0 200 300" width="70%">
            <path
